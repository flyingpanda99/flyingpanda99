...
- **RF & Communications:** SDR-based signal reception (GPS, NOAA weather satellites, radio astronomy), link budgets, comms subsystem design
- **Embedded Systems:** Arduino, Raspberry Pi, BeagleBone-based projects, sensor and PCB integration
- **Satellite Systems:** CubeSat payload/TT&C design, spacecraft system analysis, optical modulation for space-to-ground links
- **Data & Tools:** MATLAB, Python, GNU Radio, KiCad
...
Building **AI CommSat-1** — a personal project designing a modular, open CubeSat platform to help university students and amateur hobbyists build their own CubeSats. Currently includes OBC, TT&C, EPS (battery, solar, power management), and sensor subsystems, with full documentation to EU standards. An AI-based fault detection component is planned for a future phase. Website coming soon.
...
- LinkedIn: [www.linkedin.com/in/shah-mahir](https://www.linkedin.com/in/shah-mahir)
- Email: mahir.shah.97@proton.me
